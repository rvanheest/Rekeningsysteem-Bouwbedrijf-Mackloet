...
public class ParticulierFactuurTwoMetVerlegdBtwIntegrationTest extends AbstractIntegrationTest {
	...
	protected File pdfFile() {
		return new File("src\\test\\resources\\pdf\\ParticulierFactuurTwoMetVerlegdBtwIntegrationTest.pdf");
	}

	@Override
	protected File xmlFile() {
		return new File("src\\test\\resources\\xml\\ParticulierFactuurTwoMetVerlegdBtwIntegrationTest.xml");
	}
}
