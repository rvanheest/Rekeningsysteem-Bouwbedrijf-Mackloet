...
public class OfferteTrueIntegrationTest extends AbstractIntegrationTest {
	...
	protected Path pdfFile() {
		return Paths.get("src", "test", "resources", "pdf", "OfferteTrueIntegrationTest.pdf").toAbsolutePath();
	}

	@Override
	protected Path xmlFile() {
		return Paths.get("src", "test", "resources", "xml", "OfferteTrueIntegrationTest.pdf").toAbsolutePath();
	}
}
