...
public class ParticulierFactuurVerlegdBtwIntegrationTest extends AbstractIntegrationTest {
	...
	protected List<Materiaal> materiaalArtikels() {
		...
		list.add(new GebruiktEsselinkArtikel(sub1, 8, new BtwPercentage(21.0, true)));
		list.add(new GebruiktEsselinkArtikel(sub2, 1, new BtwPercentage(21.0, true)));
		list.add(new GebruiktEsselinkArtikel(sub3, 1, new BtwPercentage(21.0, true)));
		list.add(new GebruiktEsselinkArtikel(sub4, 1, new BtwPercentage(21.0, true)));
		list.add(new GebruiktEsselinkArtikel(sub5, 1, new BtwPercentage(21.0, true)));
		list.add(new GebruiktEsselinkArtikel(sub6, 1, new BtwPercentage(21.0, true)));
		list.add(new GebruiktEsselinkArtikel(sub7, 1, new BtwPercentage(21.0, true)));
		list.add(new AnderArtikel("Stucloper + trapfolie", new Geld(15.00), new BtwPercentage(9.0, true)));
		list.add(new AnderArtikel("Kitwerk", new Geld(149.50), new BtwPercentage(9.0, true)));
	...
	protected Path pdfFile() {
		return Paths.get("src", "test", "resources", "pdf", "ParticulierFactuurVerlegdBtwIntegrationTest.pdf").toAbsolutePath();
	}

	@Override
	protected Path xmlFile() {
		return Paths.get("src", "test", "resources", "xml", "ParticulierFactuurVerlegdBtwIntegrationTest.pdf").toAbsolutePath();
	}
}
