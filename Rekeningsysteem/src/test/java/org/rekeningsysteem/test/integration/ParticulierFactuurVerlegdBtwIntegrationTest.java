...
public class ParticulierFactuurVerlegdBtwIntegrationTest extends AbstractIntegrationTest {
	...
	protected ItemList<ParticulierArtikel> addArtikels() {
		...
		list.add(new GebruiktEsselinkArtikel(sub1, 8, 0));
		list.add(new GebruiktEsselinkArtikel(sub2, 1, 0));
		list.add(new GebruiktEsselinkArtikel(sub3, 1, 0));
		list.add(new GebruiktEsselinkArtikel(sub4, 1, 0));
		list.add(new GebruiktEsselinkArtikel(sub5, 1, 0));
		list.add(new GebruiktEsselinkArtikel(sub6, 1, 0));
		list.add(new GebruiktEsselinkArtikel(sub7, 1, 0));
		list.add(new AnderArtikel("Stucloper + trapfolie", new Geld(15.00), 0));
		list.add(new AnderArtikel("Kitwerk", new Geld(149.50), 0));
	...
	protected ItemList<AbstractLoon> addLoon() {
		...
		list.add(new ProductLoon("Uurloon à 38.50", 25, new Geld(38.50), 0));
		list.add(new ProductLoon("test123", 12, new Geld(12.50), 0));
		list.add(new InstantLoon("foobar", new Geld(40.00), 0));
