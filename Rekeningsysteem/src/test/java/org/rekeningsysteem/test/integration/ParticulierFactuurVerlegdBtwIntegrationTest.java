...
public class ParticulierFactuurVerlegdBtwIntegrationTest extends AbstractIntegrationTest {
	...
	protected File pdfFile() {
		return new File("src\\test\\resources\\pdf\\ParticulierFactuurVerlegdBtwIntegrationTest.pdf");
	}

	@Override
	protected File xmlFile() {
		return new File("src\\test\\resources\\xml\\ParticulierFactuurVerlegdBtwIntegrationTest.xml");
	}
}
