...
public class ParticulierOnePdfIntegrationTest extends AbstractPdfIntegrationTest {
	...
	protected File makeFile() {
		return new File("src\\test\\resources\\pdf\\ParticulierFactuurTest123OneBtw.pdf");
	}
}
