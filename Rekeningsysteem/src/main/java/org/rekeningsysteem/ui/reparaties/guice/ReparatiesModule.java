package org.rekeningsysteem.ui.reparaties.guice;
...
public class ReparatiesModule extends AbstractModule {

	@Override
	protected void configure() {
		this.bind(FactuurnummerType.class).toInstance(FactuurnummerType.FACTUUR);
		this.bind(String.class).annotatedWith(TabName.class).toInstance("Reparaties factuur");
	}
	...
	public ImageView provideButtonImage() {
		return new ImageView(new Image(Main.getResource("/images/reparaties.png")));
	}
}
