...
public abstract class AbstractDocumentManager<Doc extends AbstractDocument>
  ...
  private final BehaviorSubject<Boolean> storeDebtor = BehaviorSubject.create();
  ...
  @Override
  public BehaviorSubject<Boolean> storeDebtor() {
    return this.storeDebtor;
  }
