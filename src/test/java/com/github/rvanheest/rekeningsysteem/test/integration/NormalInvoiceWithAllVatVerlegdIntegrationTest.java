...
public class NormalInvoiceWithAllVatVerlegdIntegrationTest extends AbstractDocumentIntegrationTest {
  ...
  private void addArtikels(ItemList<NormalListItem> list, CurrencyUnit currency) throws DifferentCurrencyException {
    ...
    list.add(new EsselinkListItem(sub1, 8, 0));
    list.add(new EsselinkListItem(sub2, 1, 0));
    list.add(new EsselinkListItem(sub3, 1, 0));
    list.add(new EsselinkListItem(sub4, 1, 0));
    list.add(new EsselinkListItem(sub5, 1, 0));
    list.add(new EsselinkListItem(sub6, 1, 0));
    list.add(new EsselinkListItem(sub7, 1, 0));
    list.add(new SimpleListItem("Stucloper + trapfolie", Money.of(15.00, currency), 0));
  ...
  private void addLoon(ItemList<NormalListItem> list, CurrencyUnit currency) throws DifferentCurrencyException {
    ...
    list.add(new HourlyWage("test123", 12, Money.of(12.50, currency), 0));
    list.add(new DefaultWage("foobar", Money.of(40.00, currency), 0));
  }
