...
public class NormalInvoiceWithVatVerlegdIntegrationTest extends AbstractDocumentIntegrationTest {
  ...
  private void addArtikels(ItemList<NormalListItem> list, CurrencyUnit currency) throws DifferentCurrencyException {
    ...
    list.add(new EsselinkListItem(sub1, 8, 21));
    list.add(new EsselinkListItem(sub2, 1, 21));
    list.add(new EsselinkListItem(sub3, 1, 0));
    list.add(new EsselinkListItem(sub4, 1, 21));
    list.add(new EsselinkListItem(sub5, 1, 21));
    list.add(new EsselinkListItem(sub6, 1, 21));
    list.add(new EsselinkListItem(sub7, 1, 21));
    list.add(new SimpleListItem("Stucloper + trapfolie", Money.of(15.00, currency), 21));
    list.add(new SimpleListItem("Kitwerk", Money.of(149.50, currency), 0));
  }

  private void addLoon(ItemList<NormalListItem> list, CurrencyUnit currency) throws DifferentCurrencyException {
    list.add(new HourlyWage("Uurloon à 38.50", 25, Money.of(38.50, currency), 0));
    list.add(new HourlyWage("test123", 12, Money.of(12.50, currency), 6));
    list.add(new DefaultWage("foobar", Money.of(40.00, currency), 6));
  }
