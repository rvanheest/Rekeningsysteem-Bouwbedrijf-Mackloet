...
public class XmlReader3Test {
  ...
  public static void setUpClass() throws URISyntaxException {
    ...
    xml3Dir = Paths.get(XmlReader3Test.class.getClassLoader().getResource("xml/xml3").toURI());
  }

  @Before
  public void setUp() throws ParserConfigurationException {
    this.reader = new XmlReader3(DocumentBuilderFactory.newInstance().newDocumentBuilder());
  }
  ...
  public void testReadAangenomenInvoice() throws DifferentCurrencyException {
    ...
    Header factuurHeader = new Header(debtor, date, "122013");
  ...
  public void testReadRepairsInvoice() throws DifferentCurrencyException {
    ...
    Header factuurHeader = new Header(debtor, date, "232011");
