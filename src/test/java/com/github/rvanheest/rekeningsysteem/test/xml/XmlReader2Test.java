...
public class XmlReader2Test {
  ...
  public static void setUpClass() throws URISyntaxException {
    ...
    xml2Dir = Paths.get(XmlReader2Test.class.getClassLoader().getResource("xml/xml2").toURI());
  }

  @Before
  public void setUp() throws ParserConfigurationException {
    this.reader = new XmlReader2(DocumentBuilderFactory.newInstance().newDocumentBuilder());
  }

  @Test
  public void testReadAangenomenInvoice() throws DifferentCurrencyException {
    Debtor debiteur = new Debtor("Name", "Street", "Number", "ZipCode", "Place");
    LocalDate date = LocalDate.of(2013, 4, 5);
    Header header = new Header(debiteur, date, "122013");
    String description = "Voor u verrichte werkzaamheden";

    ItemList<NormalListItem> itemList = new ItemList<>(currency);
    itemList.add(new SimpleListItem("omschr1", Money.of(2791.25, this.currency), 21));
    itemList.add(new DefaultWage("omschr1", Money.of(5183.75, this.currency), 6));
    itemList.add(new SimpleListItem("omschr2", Money.of(1972.2, this.currency), 21));
    itemList.add(new DefaultWage("omschr2", Money.of(1314.8, this.currency), 6));
    itemList.add(new SimpleListItem("omschr3", Money.of(5667, this.currency), 21));
    itemList.add(new DefaultWage("omschr3", Money.of(2300.0, this.currency), 6));
  ...
  public void testReadOffer() {
    ...
    Header header = new Header(debtor, date, "107");
  ...
  public void testReadNormalInvoice() throws DifferentCurrencyException {
    ...
    itemList.add(new EsselinkListItem(new EsselinkItem("2003131060", "Product 3", 1, "set", Money.of(35.96, this.currency)), 1.0, 21.0));
    itemList.add(new EsselinkListItem(new EsselinkItem("2003131306", "Product 4", 1, "zak", Money.of(9.47, this.currency)), 1.0, 21.0));
    itemList.add(new EsselinkListItem(new EsselinkItem("4010272112", "Product 5", 1, "Stuks", Money.of(17.18, this.currency)), 1.0, 21.0));
    itemList.add(new EsselinkListItem(new EsselinkItem("2009200131", "Product 6", 1, "Stuks", Money.of(6.84, this.currency)), 1.0, 21.0));
    itemList.add(new EsselinkListItem(new EsselinkItem("2009200105", "Product 7", 1, "Stuks", Money.of(7.44, this.currency)), 1.0, 21.0));
  ...
  public void testReadRepairsInvoice() throws DifferentCurrencyException {
    ...
    itemList.add(new RepairListItem("Bonnummer", "111518", Money.of(57.75, this.currency), Money.zero(this.currency)));
    itemList.add(new RepairListItem("Bonnummer", "111660", Money.of(77, this.currency), Money.zero(this.currency)));
    ...
    itemList.add(new RepairListItem("Bonnummer", "111764", Money.of(77, this.currency), Money.zero(this.currency)));
    itemList.add(new RepairListItem("Bonnummer", "111751", Money.of(77, this.currency), Money.zero(this.currency)));
    itemList.add(new RepairListItem("Bonnummer", "111745", Money.of(38.5, this.currency), Money.zero(this.currency)));
    itemList.add(new RepairListItem("Bonnummer", "111571", Money.of(57.75, this.currency), Money.of(3.5, this.currency)));
    itemList.add(new RepairListItem("Bonnummer", "111876", Money.of(77, this.currency), Money.zero(this.currency)));
    ...
    itemList.add(new RepairListItem("Bonnummer", "111723", Money.of(115.5, this.currency), Money.zero(this.currency)));
